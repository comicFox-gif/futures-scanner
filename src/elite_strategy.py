...
1. Market regime clear — Bull=longs only, Bear=shorts only, Neutral=no signals
1. Liquidity sweep complete: EQL swept (wick below, close above) → long
   EQH swept (wick above, close below) → short
1. RSI in valid momentum zone: 35–75 (long), 25–65 (short)
1. 1H must confirm direction (FVG / MSS / sweep)
1. Not Friday after 17:00 UTC / Not Sunday before 22:00 UTC
